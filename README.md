# FedCure: Heterogeneity Aware Personalized Federated Learning Framework for Internet of Medical Things (IOMT) Environments.

[![License: GPL v2](https://img.shields.io/badge/License-GPL_v2-blue.svg)](https://www.gnu.org/licenses/old-licenses/gpl-2.0.en.html) [![IEEE Access](https://img.shields.io/badge/arXiv-2312.04992-b31b1b.svg)](https://ieeexplore.ieee.org/abstract/document/10412046)
<!-- 
![](./structure.png)
...
- ***traditional FL ([tFL](#traditional-fl-tfl)) or personalized FL ([pFL](#personalized-fl-pfl)) algorithms, 3 scenarios, and 5 datasets**.*
...
| Model-Regularization-based pFL |MOON | yes | Yes| yes |No | Yes | Yes |
| Multi-Task Based PFL | FedMTL | Yes | Yes | No | No|Yes | No |
| Hyper Network based PFL | pFedHN | No | No | No |Yes|No| Yes |
| Knowledge Distillation Based PFL | FedDistil,FedProto,FedPAC| yes | Yes |Yes | No | Yes | Yes |
| Model Interpolation Based pFL | FedPer | No | No | Yes | No | No |No |
| Meta Learning Based pFL | Per FedAvg | Yes | No |No | No |No | no |
...
- for Maternal
    1. DNN(6 , 20) # non-convex

- for Diabetes

    1. Mclr_Logistic(13)

- for Body Performance
    1. DNN(11 , 20) # non-convex
...
- Download [this project](https://github.com/Abhijit4-debug/FedCure-main) to an appropriate location using [git](https://git-scm.com/).
    ```bash
    git clone https://github.com/Abhijit4-debug/FedCure-main.git
    ```
